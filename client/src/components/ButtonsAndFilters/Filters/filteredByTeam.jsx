...
import { Box, ContentWrapper } from "../../Cards/styles/styledCard";
...
const FilteredByTeam = ({ filteredDriver }) => {
  ...
  const visibleDriver = filteredDriver.slice(startIndex, endIndex);
